  ...
  return (
    <PageContainer title="文件上传" description="拖拽区上传：支持点击选择与拖拽，已选文件可移除。">
      <div className="demo-block">
        <div
          className={`flex w-full max-w-md cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed py-10 text-center transition-colors ${dragOver ? 'border-primary bg-primary/5' : 'border-border'}`}
