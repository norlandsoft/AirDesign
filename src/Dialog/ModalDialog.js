...
import styles from './ModalDialog.less';
        ...
        <div className={styles.custom_modal_mask} style={{width: clientWidth, height: clientHeight}}>
          <div
            ...
            <div className={styles.custom_modal_header}>
              <div
                  className={styles.custom_modal_header_inner}
              ...
              {
                closable ? (
                    <div className={styles.custom_modal_header_close} onClick={this.doCancel}>
            ...
            <div className={styles.custom_modal_content}>
              <div className={styles.mask} style={{visibility: mask ? 'visible' : 'hidden'}}>
                <Spin size="large"/>
              </div>
              {children}
            </div>
