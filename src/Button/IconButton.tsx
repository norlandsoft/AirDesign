...
type AntdDropdownPlacement = 'top' | 'topLeft' | 'topRight' | 'bottom' | 'bottomLeft' | 'bottomRight' | 'topCenter' | 'bottomCenter';
...
const IconButton: React.FC<IconButtonProps> = props => {
  ...
  const buttonContent = (
    <div
      ...
      style={{height: size, lineHeight: `${size}px`, width: size, border: bordered ? '1px solid #ddd' : 'none', borderRadius: borderRadius, ...style}}
