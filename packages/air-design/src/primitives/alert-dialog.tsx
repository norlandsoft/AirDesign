/**
 * AlertDialog 原语：基于 Radix AlertDialog 的确认对话框
 *
 * 用于需要用户显式确认的破坏性操作，与普通 Dialog 区分。强制交互（点击遮罩/ESC 不会关闭）。
 *
...
>(({className, ...props}, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-black/50 backdrop-blur-[0.0625rem] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
    ref={ref}
